...
export default function Layout({ children, title = '桌面破坏神 Wiki' }) {
  ...
  return (
    <>
      ...
      <div className="cosmic-comet t1" /><div className="cosmic-comet t2" />
      <div className="cosmic-comet t3" /><div className="cosmic-comet t4" />
      <div className="cosmic-comet t5" /><div className="cosmic-comet t6" />
      <div className="cosmic-comet t7" />
      <div className="cosmic-comet l1" /><div className="cosmic-comet l2" />
      <div className="cosmic-comet l3" /><div className="cosmic-comet l4" />
      <div className="cosmic-comet l5" />
      <main>{children}</main>
